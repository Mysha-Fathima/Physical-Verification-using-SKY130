...
N 3640 -80 3830 -80 { lab=io_analog[4]}
N 3530 -80 3580 -80 { lab=io_clamp_high[0]}
...
C {sky130_fd_pr/res_generic_m1.sym} 3610 -80 1 0 {name=R1
W=10.99
L=1.45
model=res_generic_m3
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} 3530 -80 0 0 {name=l13 sig_type=std_logic lab=io_clamp_high[0]}
